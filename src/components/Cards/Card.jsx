      ...
      <div className='container-fluid' style={{ background: '#014FC0' }}>
        <div className="container-fluid vh-100 d-flex justify-content-center align-items-center">
          <div className="d-flex justify-content-center align-items-center w-100">
            <motion.div
              className="custom-box d-flex flex-column flex-md-row rounded overflow-hidden"
            ...
            >
              ...
              <div className="right-side col-md-6 d-flex align-items-center" style={rightSideStyle}>
                <div>
